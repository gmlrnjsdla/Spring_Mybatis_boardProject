...
<body>
	...
	%>
		...
		<input type="button" value="정보수정" onclick="javascript:window.location='modifyMember'">&nbsp;&nbsp;
		<input type="button" value="회원탈퇴" onclick="javascript:window.location='deleteMember?mid=<%=mid%>'"><br><br>
